...
_EVAL_RE = re.compile(
    ...
    # E 「一個/一套好的/完善的/有效的 X 如何/要怎麼」
    r'|(?:一個|一套|一種|好的|完善的|有效的|理想的|優質的|良好的).{0,15}(?:好的|完善的|有效的|理想的|優質的|良好的).{0,20}(?:如何|該如何|怎麼|要怎麼|應該)'
    r'|(?:一個|一套|一種)(?:好的|完善的|有效的|理想的|優質的|良好的).{0,30}(?:如何|該如何|怎麼|要怎麼|應該|建立|設計|推動)'
)
